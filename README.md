...
[![Build Status](https://github.com/mattermost/mattermost-plugin-groups/actions/workflows/ci.yml/badge.svg)](https://github.com/mattermost/mattermost-plugin-groups/actions/workflows/ci.yml)
[![E2E Status](https://github.com/mattermost/mattermost-plugin-groups/actions/workflows/e2e.yml/badge.svg)](https://github.com/mattermost/mattermost-plugin-groups/actions/workflows/e2e.yml)
...
```
git clone --depth 1 https://github.com/mattermost/mattermost-plugin-groups com.example.my-plugin
```
